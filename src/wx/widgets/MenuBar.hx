...
extern class MenuBar extends Window {
    ...
    @:native("new wxMenuBar")           private static function _new(style:Int = 0):RawPointer<MenuBar>;
                                        public static inline function createInstance(style:Int = 0):Pointer<MenuBar> return Pointer.fromRaw(_new(style));

    //////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Instance functions
    //////////////////////////////////////////////////////////////////////////////////////////////////////////
    @:native("Append")                  public function append(menu:Pointer<Menu>, title:ConstCharStar):Void;
}
