...
@:include("wx/defs.h")
@:native("cpp::Reference<wxDirection>")
extern class DirectionType {
}
...
abstract Direction(Int) {
    ...
    @:to @:unreflective
    inline public function toNative():DirectionType return untyped __cpp__("static_cast<wxDirection>({0})", this);
