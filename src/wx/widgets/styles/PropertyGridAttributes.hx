...
class PropertyGridAttributes {
    ...
    public static var COLOUR_HAS_ALPHA                  = untyped __cpp__("wxPG_COLOUR_HAS_ALPHA");
    public static var DATE_FORMAT                       = untyped __cpp__("wxPG_DATE_FORMAT");
    public static var DATE_PICKER_STYLE                 = untyped __cpp__("wxPG_DATE_PICKER_STYLE");
    public static var DIALOG_TITLE                      = untyped __cpp__("wxPG_DIALOG_TITLE");
    public static var FILE_DIALOG_STYLE                 = untyped __cpp__("wxPG_FILE_DIALOG_STYLE");
    public static var FILE_INITIAL_PATH                 = untyped __cpp__("wxPG_FILE_INITIAL_PATH");
    public static var FILE_SHOW_FULL_PATH               = untyped __cpp__("wxPG_FILE_SHOW_FULL_PATH");
    public static var FILE_SHOW_RELATIVE_PATH           = untyped __cpp__("wxPG_FILE_SHOW_RELATIVE_PATH");
    public static var FILE_WILDCARD                     = untyped __cpp__("wxPG_FILE_WILDCARD");
    public static var FLOAT_PRECISION                   = untyped __cpp__("wxPG_FLOAT_PRECISION");
    public static var STRING_PASSWORD                   = untyped __cpp__("wxPG_STRING_PASSWORD");
    public static var UINT_BASE                         = untyped __cpp__("wxPG_UINT_BASE");
    public static var UINT_PREFIX                       = untyped __cpp__("wxPG_UINT_PREFIX");
}